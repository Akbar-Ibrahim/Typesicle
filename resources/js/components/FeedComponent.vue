...
<!-- For small screens -->
            <div class="w3-row-padding w3-hide-large">
                <div class="w3-col s4">
                    <button
                        ref="allRef"
                        style="width: 100%; background-color: #212121, color: white"
                        class="tabs btn btn-default btn-lg"
                        @click="getFeeds"
                    >
                        All
                    </button>
        ...
        <div ref="allContainer">
            <div v-for="(feed, i) in feeds" :key="i">
                ...
                <div
                    v-else-if="feed.status === 'Shortie' && feed.thread == null"
                    class="w3-container"
                >
                    <my-shortie-component
