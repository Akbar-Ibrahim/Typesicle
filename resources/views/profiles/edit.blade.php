...
<h1> Edit Profile </h1>
        ...
        <div class="w3-container " style="width: 60%; margin: auto;">
            ...
            <div class="" style="margin: auto; margin-top: 100px;">
                <form action="{{ route('profile-edit') }}" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="username" value="{{ str_replace('@', '', $user->username) }}"> <br>
                    <input type="text" name="bio" value="{{ $user->profile->bio }}"> <br>
                    ...
                    <div>
                        <input type="text" name="website" placeholder="Website" value=""> <br>
                        <input type="text" name="facebook" placeholder="Facebook" value=""> <br>
                        <input type="text" name="twitter" placeholder="Twitter" value=""> <br>
                        <input type="text" name="instagram" placeholder="Instagram" value=""> <br>
                    </div>
