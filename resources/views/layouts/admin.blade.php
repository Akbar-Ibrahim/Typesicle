    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        <div class="w3-container w3-row">
            ...
            <div class="w3-col s8 w3-bar">
                <span> <a style="text-decoration: none;" href="{{ route('profile.show', Auth::user()->username) }}"> {{ Auth::user()->name }} </a> <br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="/admin/users/index" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i> Users</a>
