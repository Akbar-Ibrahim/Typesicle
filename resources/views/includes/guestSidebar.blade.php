<nav class="w3-sidebar w3-bar-block w3-collapse w3-text-white w3-animate-left w3-card "
    ...
    <div class="w3-container" style="margin-bottom: 40px;">
        <div class="w3-container w3-center" style="margin-bottom: 20px;">
            <a style="width: 100%; background-color: #7CFC00" class="btn btn-default btn-lg w3-border w3-text-white"
                href="/register">Get Started</a>
        </div>

        <div class="w3-container w3-center">
            <a style="width: 100%; background-color: #7CFC00" class="btn btn-default btn-lg w3-text-white"
    ...
    <div class="w3-bar-block">
        <div class="">
            ...
            <div class="w3-container w3-center">
                <a style="width: 100%; border: 1px solid #212121;" href="/"
                    class="w3-bar-item btn btn-default btn-lg w3-text-white menu-links">
                    Home</a>
            </div>
            <div class="w3-container w3-center">
                <a style="width: 100%; border: 1px solid #212121;" href="{{ route('top-pages') }}"
                    class="w3-bar-item btn btn-default btn-lg  w3-text-white menu-links"> Top
                    Pages</a>
            </div>
            <div class="w3-container w3-center">
                <a style="width: 100%; border: 1px solid #212121;" href="{{ route('discover') }}"
